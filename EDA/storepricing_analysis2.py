...
# =================================================================================
# SCRIPT: store_prcing_analysis.py
# AUTHOR: SAMARTH P SHET
# DESCRIPTION: This script performs an in-depth analysis of product pricing data,
#              including temporal trends, geographic patterns, promotional impact,
#              store clustering, product volatility, and category-specific insights.
# =================================================================================
...
# --- Feature Engineering ---
# 1. Add a 'competitor_price_amt' for price gap analysis
df['competitor_price_amt'] = df['live_price_amt'] * np.random.uniform(0.9, 1.1, 5000).round(2)
# 2. Calculate price_gap
df['price_gap'] = df['live_price_amt'] - df['competitor_price_amt']
# 3. Add time-based features
df['month'] = df['date'].dt.month
df['day_of_week'] = df['date'].dt.day_name()
# 4. Add price_cents for Benford's Law analysis
df['price_cents'] = (df['live_price_amt'] * 100 % 100).astype(int)
